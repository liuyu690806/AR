...
QT_MOC_LITERAL(1, 11, 16), // "send_jobnum_main"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "selectitems"
QT_MOC_LITERAL(4, 41, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(5, 58, 10), // "get_jobnum"
QT_MOC_LITERAL(6, 69, 7) // "get_job"

    },
    "mainscence\0send_jobnum_main\0\0selectitems\0"
    "QTreeWidgetItem*\0get_jobnum\0get_job"
};
...
void mainscence::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_jobnum_main((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->selectitems((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainscence::send_jobnum_main)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mainscence::send_jobnum_main(QString _t1)
{
