...
#include "../../Auxiliary_maintenance/mylabel.h"
...
QT_MOC_LITERAL(1, 8, 14), // "Afor_an_accout"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Mylabel\0Afor_an_accout\0"
};
...
void Mylabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Afor_an_accout(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Mylabel::Afor_an_accout)) {
                *result = 0;
                return;
            }
        }
